...
$string['reksigningkeyid_help'] = 'The ID of the key to use to access Rekcognition.';
$string['reksigningsecretkey'] = 'Secret Key';
$string['reksigningsecretkey_help'] = 'The secret key to use to access Rekcognition.';
